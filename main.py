...
rag = RAG(file_path, device, generator_name=generator_name, context_model_name=context_model_name, question_model_name=question_model_name)

def main():
    print("Ask a question about the attention paper!")
